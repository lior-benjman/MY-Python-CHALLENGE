...
base = float(input("Please insert base of the triangle "))
height = float(input("please insert the height of the triangle "))
result= base*height*0.5
print(f"The area of the triangle is: {result}")

a = float(input("enter side a of the triangle: "))
b = float(input("now enter side b: "))
c = float(input("and now enter side c: "))
perimeter = a + b + c
print(f"this is your perimeter: {perimeter}")
